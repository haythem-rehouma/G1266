...
On ne fait pas ici les formules RL exactes, on utilise l’intuition “moyenne pondérée”.
...
| Méthode      | Interprétation temporelle |
|--------------|---------------------------|
| TD(0)        | Très court terme          |
| TD(λ = 0.3)  | Court–moyen terme         |
| TD(λ = 0.7)  | Terme moyen               |
| TD(λ = 0.8)  | Moyen–long terme          |
| TD(λ = 0.9)  | Long terme                |
| Monte Carlo  | Très long terme           |
